...
void main(){
	...
	// G: Não há problema em delta ser igual à 0, a raiz quadrada de 0 é 0 pois 0 * 0 = 0
	// G: O que deve ser realmente verificado é se o valor de a == 0, pois isso levaria à uma divisão por 0
        if (delta!=0) 
         if (delta > 0){
